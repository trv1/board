...
DBPORT="5432"
DBUSER="postgres"
FILES="allCountries.zip alternateNames.zip admin1CodesASCII.txt admin2Codes.txt countryInfo.txt featureCodes_ru.txt iso-languagecodes.txt timeZones.txt hierarchy.txt"
...
CREATE TABLE postalcodes (
    ...
    longitude   FLOAT,
    accuracy    SMALLINT,
    PRIMARY KEY (countrycode, admin1code, admin2code, admin3code, postalcode)
);
